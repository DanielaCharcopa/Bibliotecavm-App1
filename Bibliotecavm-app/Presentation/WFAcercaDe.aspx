...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Colaboradores</h2>
    <p>Contamos con el apoyo de la Fundación Universitaria de Popayán, el Cabildo Indígena de Guambía y otros colaboradores que han contribuido al desarrollo y sostenibilidad de la biblioteca.</p>
    ...
    <h2>Contacto</h2>
    <p>Para más información, puedes contactarnos a través de nuestro correo electrónico: <a href="mailto:contacto@bibliotecamisak.org">contacto@bibliotecamisak.org</a> o visitar nuestras oficinas en el resguardo indígena de Guambía.</p>
</asp:Content>
